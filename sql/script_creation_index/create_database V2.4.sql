...
CREATE TABLE common(
        ...
        position   Int NOT NULL ,
        id_article Int NOT NULL ,
        PRIMARY KEY (id_synonym ,position ,id_article )
)ENGINE=InnoDB;
...
ALTER TABLE position_word ADD CONSTRAINT FK_position_word_id_article_1 FOREIGN KEY (id_article) REFERENCES article(id_article);
