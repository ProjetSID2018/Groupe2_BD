...
DELIMITER |
CREATE PROCEDURE PPOSITION_WORD (IN VPOSITION INT, IN VTITLE BOOLEAN, IN VID_WORD INT, VID_ENTITY INT, IN VID_POS_TAG INT, IN VID_ARTICLE INT,IN VID_WIKI INT)   
...
DELIMITER ;
CALL PPOSITION_WORD(18,TRUE,1,1,1,2,1);